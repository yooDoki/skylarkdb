...
export function SettingsDialog({
  ...
  const ThemeOption = ({
    ...
    <button
      ...
      className={`relative flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all hover:bg-accent flex-1 ${
    ...
    >
      ...
      {settings.theme === value && (
        <div className="absolute top-3 right-3 p-1 rounded-full bg-primary/20">
  ...
  return (
    <>
      {trigger ? (
        <span onClick={handleTriggerClick} className="inline-flex cursor-pointer">
          {trigger}
        </span>
      ) : (
        <Button
      ...
      <Dialog open={isOpen} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[560px] h-[600px] max-h-[85vh] p-0 overflow-hidden flex flex-col">
          <DialogHeader className="px-6 pt-6 pb-2">
            ...
            <p className="text-sm text-muted-foreground mt-1">自定义 SkylarkDB 的外观和行为</p>
          </DialogHeader>
                  ...
                  <div className="space-y-4 pb-4">
                    <Card>
                      ...
                      <CardContent className="py-0">
                        ...
                        <SettingRow id="word-wrap" label="自动换行" description="长行自动换行显示">
                          <Switch
                            id="word-wrap"
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-3">
                            <Input
                              ...
                              onChange={e =>
                                updateSetting('connectionTimeout', Number(e.target.value))
                              }
                              className="w-24"
                            />
                            <span className="text-sm text-muted-foreground">范围: 5-300 秒</span>
                          </div>
                        </div>
                        ...
                        <div className="border-t border-border pt-4 space-y-2">
                          ...
                          <div className="flex items-center gap-3">
                            <Input
                              ...
                              className="w-24"
                            />
                            <span className="text-sm text-muted-foreground">范围: 10-200 行</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
