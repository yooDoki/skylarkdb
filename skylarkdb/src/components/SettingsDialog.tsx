...
export function SettingsDialog({ open: controlledOpen, onOpenChange, trigger }: SettingsDialogProps) {
  ...
  // Debug logs
  console.log('SettingsDialog props:', { controlledOpen, onOpenChange, trigger });
  console.log('SettingsDialog state:', { internalOpen, isOpen, isLoaded });
            ...
            {!isLoaded ? (
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">加载设置中...</p>
                </div>
              </div>
            ) : (
